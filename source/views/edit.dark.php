                    ...
                    <vault:card>
                        <vault:allowed permission="vault.pages.add">
                            <div class="row">
                                ...
                                <div class="col s12 m8">
                            <span
                                class="grey-text"> [[Open "create" page with inserted fields to create a copy of the current page.]]</span>
                                </div>
                            </div>
                        </vault:allowed>
                    </vault:card>
                        ...
                        <?php if (!$page->status->isDeleted()) { ?>
                            <vault:allowed permission="vault.pages.delete">
                                <div class="row">
                                    ...
                                    <div class="col s12 m8">
                            <span
                                class="grey-text"> [[Delete page. It can be restored after deletion, ask your webmaster.]]</span>
                                    </div>
                                </div>
                            </vault:allowed>
                        <?php } ?>
